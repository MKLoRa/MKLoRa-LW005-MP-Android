...
public enum OrderCHAR implements Serializable {
    // 1800
    CHAR_DEVICE_NAME(UUID.fromString("00002A00-0000-1000-8000-00805F9B34FB")),
    // 180A
    ...
    // 180F
    CHAR_DEVICE_BATTERY(UUID.fromString("00002A19-0000-1000-8000-00805F9B34FB")),
    // AA00
    ...
    CHAR_STORAGE_DATA_NOTIFY(UUID.fromString("0000AA03-0000-1000-8000-00805F9B34FB")),
    ;
