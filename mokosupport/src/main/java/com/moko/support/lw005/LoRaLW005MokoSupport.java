...
public class LoRaLW005MokoSupport extends MokoBleLib {
    ...
    public static LoRaLW005MokoSupport getInstance() {
        if (INSTANCE == null) {
            synchronized (LoRaLW005MokoSupport.class) {
                if (INSTANCE == null) {
                    INSTANCE = new LoRaLW005MokoSupport();
                }
            }
        }
        return INSTANCE;
