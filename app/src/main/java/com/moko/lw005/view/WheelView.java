...
public class WheelView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs, R.styleable.LW005WheelView);
        unitHeight = (int) attribute.getDimension(R.styleable.LW005WheelView_unitHeight, unitHeight);
        itemNumber = attribute.getInt(R.styleable.LW005WheelView_itemNumber, itemNumber);

        normalFont = attribute.getDimension(R.styleable.LW005WheelView_normalTextSize, normalFont);
        selectedFont = attribute.getDimension(R.styleable.LW005WheelView_selectedTextSize, selectedFont);
        normalColor = attribute.getColor(R.styleable.LW005WheelView_normalTextColor, normalColor);
        selectedColor = attribute.getColor(R.styleable.LW005WheelView_selectedTextColor, selectedColor);

        lineColor = attribute.getColor(R.styleable.LW005WheelView_lineColor, lineColor);
        lineHeight = attribute.getDimension(R.styleable.LW005WheelView_lineHeight, lineHeight);

        selectedBgColor = attribute.getColor(R.styleable.LW005WheelView_selectedBgColor, selectedBgColor);

        maskHeight = attribute.getDimension(R.styleable.LW005WheelView_maskHeight, maskHeight);
        noEmpty = attribute.getBoolean(R.styleable.LW005WheelView_noEmpty, true);
        isEnable = attribute.getBoolean(R.styleable.LW005WheelView_isEnable, true);
    ...
    private void drawSelectedBg(Canvas canvas) {
        if (selectedBgPaint == null) {
            selectedBgPaint = new Paint();
            selectedBgPaint.setColor(selectedBgColor);
        }
        canvas.drawRect(0, controlHeight / 2 - unitHeight / 2, controlWidth, controlHeight / 2 + unitHeight / 2, selectedBgPaint);
    }
