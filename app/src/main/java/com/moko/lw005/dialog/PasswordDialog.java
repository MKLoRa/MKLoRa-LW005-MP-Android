...
import com.moko.lw005.databinding.Lw005DialogPasswordBinding;
import com.moko.lw005.utils.ToastUtils;

public class PasswordDialog extends BaseDialog<Lw005DialogPasswordBinding> {
    ...
    @Override
    protected Lw005DialogPasswordBinding getViewBind() {
        return Lw005DialogPasswordBinding.inflate(getLayoutInflater());
    }
