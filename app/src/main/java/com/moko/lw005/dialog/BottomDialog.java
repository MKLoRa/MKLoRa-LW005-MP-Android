...
import com.moko.lw005.databinding.Lw005DialogBottomBinding;

import java.util.ArrayList;

public class BottomDialog extends MokoBaseDialog<Lw005DialogBottomBinding> {
    ...
    @Override
    protected Lw005DialogBottomBinding getViewBind(LayoutInflater inflater, ViewGroup container) {
        return Lw005DialogBottomBinding.inflate(inflater, container, false);
    }
