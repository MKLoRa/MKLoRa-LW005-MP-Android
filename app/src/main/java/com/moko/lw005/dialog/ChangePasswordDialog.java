...
import com.moko.lw005.databinding.Lw005DialogChangePasswordBinding;
import com.moko.lw005.utils.ToastUtils;


public class ChangePasswordDialog extends BaseDialog<Lw005DialogChangePasswordBinding> {
    ...
    @Override
    protected Lw005DialogChangePasswordBinding getViewBind() {
        return Lw005DialogChangePasswordBinding.inflate(getLayoutInflater());
    }
