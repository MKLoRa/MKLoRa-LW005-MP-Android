...
public class AuxiliaryOperationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw005_activity_auxiliary_operation);
        ...
        LoRaLW005MokoSupport.getInstance().sendOrder(OrderTaskAssembler.getTamperAlarm());
    }
                                ...
                                switch (configKeyEnum) {
                                    case KEY_TAMPER_ALARM:
                                        if (length > 0) {
                                            ...
                                            ivTamperAlarm.setImageResource(mTamperAlarmEnable ? R.drawable.lw005_ic_checked : R.drawable.lw005_ic_unchecked);
                                        }
                                        break;
                                }
                            }
