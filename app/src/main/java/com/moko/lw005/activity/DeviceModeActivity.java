...
public class DeviceModeActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw005_activity_device_mode);
        ...
        LoRaLW005MokoSupport.getInstance().sendOrder(OrderTaskAssembler.getWorkMode());
    }
    ...
    public void selectDeviceMode(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW005MokoSupport.getInstance().sendOrder(OrderTaskAssembler.setWorkMode(mSelected));
        });
        dialog.show(getSupportFragmentManager());
    }
