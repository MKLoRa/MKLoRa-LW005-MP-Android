...
public class OnOffActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lw005_activity_on_off_settings);
                                ...
                                switch (configKeyEnum) {
                                    case KEY_REED_SWITCH:
                                        if (length > 0) {
                                            ...
                                            ivMagnet.setImageResource(mMagnetEnable ? R.drawable.lw005_ic_checked : R.drawable.lw005_ic_unchecked);
                                        }
                                        break;
                                    case KEY_POWER_STATUS:
                                        if (length > 0) {
    ...
    public void selectDefaultMode(View view) {
        ...
        dialog.setListener(value -> {
            ...
            showSyncingProgressDialog();
            LoRaLW005MokoSupport.getInstance().sendOrder(OrderTaskAssembler.setPowerStatus(value));
        });
        dialog.show(getSupportFragmentManager());
    }
